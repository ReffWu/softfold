...
默认的打开角度是 100°。想换一个？调到你舒服的角度，点 **设为打开角度**，Softfold 会记住。在任何地方按 <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>H</kbd> 都能开启或关闭它。
...
支持英语、简体中文、繁体中文、日语、韩语、德语、法语、西班牙语、意大利语、巴西葡萄牙语、俄语、荷兰语、土耳其语、波兰语、阿拉伯语和越南语。默认跟随系统语言，也可以在 **设置 > 控制 > 语言** 里单独选择。
