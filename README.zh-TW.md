...
預設的開啟角度是 100°。想換一個？調到你舒服的角度，按 **設為開啟角度**，Softfold 會記住。在任何地方按 <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>H</kbd> 都能開啟或關閉它。
...
支援英文、簡體中文、繁體中文、日文、韓文、德文、法文、西班牙文、義大利文、巴西葡萄牙文、俄文、荷蘭文、土耳其文、波蘭文、阿拉伯文和越南文。預設跟隨系統語言，也可以在 **設定 > 控制 > 語言** 裡另外選擇。
