...
처음 켤 때의 덮개 각도가 열림 각도로 설정됩니다. 나중에 바꾸려면 원하는 위치에 덮개를 두고 **현재 각도 사용**을 클릭하세요. <kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>H</kbd>로 어디서든 켜고 끌 수 있습니다. 흰색 테두리 아이콘을 원하면 Softfold 창에서 고를 수 있습니다.
