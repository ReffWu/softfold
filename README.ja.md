...
初めてオンにしたときのふたの角度が、開いた角度として設定されます。あとから変えるときは、好みの位置にふたを合わせて **現在の角度を使用** をクリックします。<kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>H</kbd> でどこからでもオン/オフできます。白いフレームのアイコンにしたいときは Softfold のウインドウで選べます。
