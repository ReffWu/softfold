...
開いた角度の初期値は 100° です。好みの角度にしたいときは、楽な姿勢で **開いた位置を設定** をクリックすると Softfold が覚えます。<kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>H</kbd> でどこからでもオン/オフできます。
...
英語、簡体字中国語、繁体字中国語、日本語、韓国語、ドイツ語、フランス語、スペイン語、イタリア語、ブラジルポルトガル語、ロシア語、オランダ語、トルコ語、ポーランド語、アラビア語、ベトナム語に対応しています。Mac の言語設定に従うほか、**設定 > 操作 > 言語** で個別に選べます。
