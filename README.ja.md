...
開いた角度の初期値は 100° です。好みの角度にしたいときは、楽な姿勢で **現在の角度を使用** をクリックすると Softfold が覚えます。<kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>H</kbd> でどこからでもオン/オフできます。白いフレームのアイコンにしたいときは Softfold のウインドウで選べます。
