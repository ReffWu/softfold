...
開いた角度の初期値は 100° です。好みの角度にしたいときは、楽な姿勢で **開いた位置を設定** をクリックすると Softfold が覚えます。<kbd>⌃</kbd> <kbd>⌥</kbd> <kbd>H</kbd> でどこからでもオン/オフできます。白いフレームのアイコンにしたいときは **一般 > 外観 > アプリアイコン** で切り替えられます。
